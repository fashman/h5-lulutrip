<template>
  <div class="ad-swiper" v-if="product.ads && product.ads.length > 0">
    <swiper ref="adsSwiper">
      <swiper-slide v-for="(ad, index) in product.ads" :key="index">
        <a class="ad-item" :href="ad.link">
          <img :src="ad.pic" />
          <span>{{ad.title}}</span>
        </a>
      </swiper-slide>
  ...
  <a v-else :href="product.link" class="product-item">
